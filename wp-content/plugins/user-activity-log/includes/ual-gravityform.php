...
add_action('gform_pre_note_deleted', 'ualgform_pre_note_deleted',10,2); // todo
...
add_action('gform_post_note_added', 'ualgform_post_note_added', 10, 6); // todo
...
add_action('gform_delete_entries', 'ualgform_delete_entries', 10, 2); // todo
