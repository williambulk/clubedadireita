 ...
 */
if (!function_exists('ual_wpseo_opengraph')){

    function ual_wpseo_opengraph() {
        $action = "Opengraph";
        $obj_type = 'Yoast SEO';
        $post_id = '';
...
add_action('wpseo_opengraph', 'ual_wpseo_opengraph');

/*
 *  Fires when Twitter output added
 */
if (!function_exists('ual_wpseo_twitter')){

    function ual_wpseo_twitter() {
        $action = "Twitter";
        $obj_type = 'Yoast SEO';
        $post_id = '';
...
add_action('wpseo_twitter', 'ual_wpseo_twitter');
...
if(!function_exists('ualWpSEOUpdatedOption')){
    function ualWpSEOUpdatedOption( $option, $old_value = null, $value= null ) {
        ...
        $seo_removed_array = array('breadcrumbs-blog-remove','hideeditbox-post','hideeditbox-page','hideeditbox-attachment','hideeditbox-product','hideeditbox-sol_portfolio','hideeditbox-sol_project','hideeditbox-tset','hideeditbox-tax-category',
            'hideeditbox-tax-post_tag','hideeditbox-tax-post_format','hideeditbox-tax-product_cat','hideeditbox-tax-product_tag','hideeditbox-tax-product_shipping_class','hideeditbox-tax-portfolio-category','hideeditbox-tax-portfolio-tag','hideeditbox-tax-sol_project_category');
...
if(!function_exists('ual_get_changed_keys')){
    function ual_get_changed_keys($old_value, $new_value, $deep = false) {
        ...
        $diff = array_udiff_assoc(
            $old_value, $new_value, function( $value1, $value2 ) {
