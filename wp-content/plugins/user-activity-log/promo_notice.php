        ...
        echo '
            ...
            <style>/* Promotional notice css*/
                ...
                <div class="notice notice-success" id="ual_promo" style="min-height:120px">
                        ...
                        <p style="font-size:16px">' . __("We are glad you like", "user-activity-log").' <strong>'.__('User Activity Log','user-activity-log').'</strong> '.__("plugin and have been using it since the past few days. It is time to take the next step.", "user-activity-log") . '</p>
                        <p>
                                ...
                                <a class="ual_button ual_button2" target="_blank" href="https://wordpress.org/support/plugin/user-activity-log/reviews/?filter=5">' . __("Rate it", "user-activity-log") ." 5★'s". '</a>
